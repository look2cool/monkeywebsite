/*
 * Title:   monkeyisland | Responsive HTML5 Travel Template - Main Javascript file
...
function changemonkeyislandElementUI() {
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="monkeyisland - home" href="index.html"><img alt="" src="images/logo.png"></a></h1>').insertBefore('.chaser .menu');
...
// login box
tjq("body").on("click", ".monkeyisland-signup-box .signup-email", function(e) {
    e.preventDefault();
    tjq(this).closest(".monkeyisland-signup-box").find(".simple-signup").hide();
    tjq(this).closest(".monkeyisland-signup-box").find(".email-signup").show();
    tjq(this).closest(".monkeyisland-signup-box").find(".email-signup").find(".input-text").eq(0).focus();
});
